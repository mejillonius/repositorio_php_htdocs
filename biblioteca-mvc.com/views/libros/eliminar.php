        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                ?>
                        ...
                        <p class="text-center">
                            <a class="btn btn-primary" href="?section=libros&action=listar">
                ...
                ?>
                        <h3>
                            Confirmación de la Baja del Libro con código: <?php echo $libro->codigo; ?>
                        </h3>
                        ...
                        <div class="message-confirm">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <form method="post">
                                        <input type="hidden" name="codigo_libro_baja" value="<?=$libro->codigo?>">
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <p class="text-center">
                                                    <button type="submit" class="btn btn-danger">
                                                        <i class="fa fa-trash-o"></i> Eliminar Libro
                                                    </button>
                                                </p>
                                            </div>
                                        </div>
