<?php
//Aquí llamo al archivo que ejecuta los llalas clases y crea los objetos necesarios
...
//Aquí luego de borrar el registro seleccionado, lo redirecciono al archivo index.php, el cual muestra la lista de películas
